...
```{r Jungian1, fig.align = 'center', out.width = '75%', fig.cap = 'Fig 1.0 Three types of exposure-based methods(1)'}
...
These steps will result in the generation of a single R Notebook file containing the R source code. This R Notebook file must be configured to generate a PDF report **(1200 words excluding plots or tables with a maximum of 5 plots/tables allowed)**. The R Notebook **must** have the following structure:
